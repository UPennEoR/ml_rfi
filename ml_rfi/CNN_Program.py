...
def visualize_output(
    ...
    ----------
    uvd : UVData object
        The input object to visualize flags from.
    num_vis : int
        The number of waterfalls to show.
    show_folds : bool
        Whether to overplot lines where the folds in the data are.
    in_data : bool
        Whether to also plot the input data.
    font_size : int
        The font size to use in plots.
    fig_length : int
        The width of the resulting figure.
    fig_height : int
